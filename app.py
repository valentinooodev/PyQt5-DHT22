...
class Ui_MainWindow(object):
	...
	background-color: qconicalgradient(cx:0.5, cy:0.5, angle:90, stop:{STOP_1} {COLOR}, stop:{STOP_2} rgba(255, 255, 255, 0));
        ...
        if temp == 100:
            ...
            stop_2 = "1.000"
        newStylesheet = (
            styleSheet.replace("{STOP_1}", stop_1)
            .replace("{STOP_2}", stop_2)
            .replace("{COLOR}", tempColor)
        )
    ...
    def setupUi(self, MainWindow):
        ...
        self.circularTemp.setStyleSheet(
            "QFrame{\n"
            "    border-radius: 110px;    \n"
        ...
        self.circularContainer.setStyleSheet(
            "QFrame{\n"
            "    border-radius: 95px;    \n"
        ...
        self.labelTemp.setStyleSheet(
            "color: rgb(139, 233, 253); padding: 0px; background-color: none;"
        )
        ...
        self.labelCredits.setStyleSheet(
            "color: rgb(148, 148, 216); background-color: none;"
        )
        ...
        self.circularHum.setStyleSheet(
            "QFrame{\n"
            "    border-radius: 110px;    \n"
        ...
        self.circularHumBg.setStyleSheet(
            "QFrame{\n"
            "    border-radius: 110px;    \n"
            "    background-color: rgba(85, 85, 127, 100);\n"
            "}"
        ...
        self.circularContainer_3.setStyleSheet(
            "QFrame{\n"
            "    border-radius: 95px;    \n"
            "    background-color: rgb(98, 114, 164);\n"
            "}"
        ...
        self.labelHum.setStyleSheet(
            "color: rgb(255, 85, 85); padding: 0px; background-color: none;"
        )
        ...
        self.label_title.setStyleSheet(
            "color: rgb(248, 248, 242); background-color: none; font-size: 22px;"
        )
        ...
        self.label_weekDay.setStyleSheet(
            "color: rgb(248, 248, 242); font-size: 12px; padding-left: 2px; padding-right: 2px; border: none;"
        )
